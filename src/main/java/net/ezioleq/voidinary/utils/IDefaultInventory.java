...
/**
 * Basic inventory implementation, stolen from
 * <a href="https://fabricmc.net/wiki/tutorial:inventory">fabricmc.net</a>
 */
public interface IDefaultInventory extends Inventory {
	/**
	 ...
	 */
	static IDefaultInventory of(DefaultedList<ItemStack> items) {
		return () -> items;
	}
	 ...
	 */
	static IDefaultInventory ofSize(int size) {
	 ...
	 *              inventory, it gets resized to this inventory's maximum amount.
	 */
	@Override
	...
	/**
	 * Handle changes in the inventory
	 */
	...
	/**
	 * Drop items stored in the inventory
	 * 
	 * @param world
	 * @param blockPos
	 */
	default void dropEverything(World world, BlockPos blockPos) {
